...
export default function GuruPage() {
    ...
    const fetchSchedules = async () => {
        try {
            const res = await apiFetch(`/api/academic/schedules`);
    ...
    const fetchAttendances = async () => {
        try {
            const res = await apiFetch(`/api/academic/teacher-attendances`);
    ...
    const fetchEmptyClasses = async () => {
        setLoading(true);
        try {
            const res = await apiFetch(`/api/academic/empty-classes`);
