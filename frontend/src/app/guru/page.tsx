...
export default function GuruPage() {
    ...
    const fetchTeachers = async () => {
        try {
            const res = await apiFetch(`${process.env.NEXT_PUBLIC_API_URL || "http://50.50.50.20:8080"}/api/academic/teachers");
    ...
    const fetchSchedules = async () => {
        try {
            const res = await apiFetch(`${process.env.NEXT_PUBLIC_API_URL || "http://50.50.50.20:8080"}/api/academic/schedules");
    ...
    const fetchAttendances = async () => {
        try {
            const res = await apiFetch(`${process.env.NEXT_PUBLIC_API_URL || "http://50.50.50.20:8080"}/api/academic/teacher-attendances");
    ...
    const fetchEmptyClasses = async () => {
        setLoading(true);
        try {
            const res = await apiFetch(`${process.env.NEXT_PUBLIC_API_URL || "http://50.50.50.20:8080"}/api/academic/empty-classes");
