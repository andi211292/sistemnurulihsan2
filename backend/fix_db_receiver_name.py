...
# Add to Cloud DB
run_sql(cloud_engine, "ALTER TABLE payment_transactions ADD COLUMN IF NOT EXISTS receiver_name TEXT;", "Cloud")
# Add to Local DB
run_sql(local_engine, "ALTER TABLE payment_transactions ADD COLUMN receiver_name TEXT;", "Local")
